...
public class PremierLeagueDAO {
	...
	public void listAllPlayers(Map<Integer, Player> idMap){
		String sql = "SELECT DISTINCT p.PlayerID, p.Name, a.TeamID FROM Players as p, Actions as a WHERE p.PlayerID=a.PlayerID";
		...
		try {
			...
			while (res.next()) {
				...
				Player player = new Player(res.getInt("PlayerID"), res.getString("Name"), res.getInt("TeamID"));
	...
	public List<Player> getVertici(Match m, Map<Integer, Player> idMap) {
		String sql = "SELECT PlayerID, (totalSuccessfulPassesAll + assists)/timePlayed as eff FROM Actions WHERE MatchID = ?";
